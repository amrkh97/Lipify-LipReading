...
class CharCNN(object):
    ...
    def build(self):
        ...
        self.conv_1 = Conv2D(32, (3, 5), strides=(1, 2), activation='relu', kernel_initializer='he_normal', name='conv_1')(self.zero_1)
        ...
        self.conv_2 = Conv2D(64, (3, 5), strides=(1, 2), activation='relu', kernel_initializer='he_normal', name='conv_2')(self.zero_2)
        ...
        self.conv_3 = Conv2D(96, (3, 5), strides=(1, 2), activation='relu', kernel_initializer='he_normal', name='conv_3')(self.zero_3)
